...
@MODELS.register_module(name="EfficientRPN")
class EfficientRPN(BaseDetector, RPNTestMixin):
    ...
    def init_weights(self, pretrained=None):
        super(EfficientRPN, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, dataset=None, top_k=20):
        ...
        for img, img_meta in zip(imgs, img_metas):
            ...
            img_show = img[:h, :w, :]
            imshow_bboxes(img_show, result, top_k=top_k)
