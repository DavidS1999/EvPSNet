...
class EfficientTwoStageDetector(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(EfficientTwoStageDetector, self).__init__()
        ...
        if mask_head is not None:
            if mask_roi_extractor is not None:
                self.mask_roi_extractor = MODELS.build(
                    mask_roi_extractor)
    ...
    def init_weights(self, pretrained=None):
        super(EfficientTwoStageDetector, self).init_weights(pretrained)
        if self.eff_backbone_flag == False:
